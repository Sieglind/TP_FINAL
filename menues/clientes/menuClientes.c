    ...
    while (opcion != ESCAPE) {
        switch (opcion) {
            case 0:
                ...
                break;
            case 1:
                resultado = opBuscarCliente(arrayNroCliente);
...
int menuActualizarCliente() {
    ...
    while (opcion != ESCAPE) {
        switch (opcion) {
            ...
            case 1:
                resultado = opBuscarCliente(arrayNroCliente);
                if (resultado.status == 200) cliente = *resultado.resultados;
                opcion = resultado.status;
                break;
            case 200:
    ...
    while (opcion != ESCAPE) {
        switch (opcion) {
            case 0:
                ...
                break;
            case 28:
                opcion = menuCrearCliente();
                break;
            case 43:
                opcion = menuBuscarCliente();
                break;
            case 58:
                opcion = menuListarClientes();
                break;
            case 73:
                opcion = menuActualizarCliente();
                break;
            case 88:
